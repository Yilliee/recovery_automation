...
echo "Cloning trees"
cd ~/twrp-11
git clone https://github.com/Yilliee/recovery_m21 -b twrp-11 ~/twrp-11/device/samsung/m21 --depth=1 --single-branch
...
mv recovery.img TWRP-11-${version}-m21-m31-f41-$(TZ='Asia/Karachi' date "+%Y%m%d-%H%M").img
