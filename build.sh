...
git pull https://github.com/Yilliee/android_bootable_recovery android-11
git clone https://github.com/SHRP/android_vendor_shrp -b v3_11 ~/twrp-11/vendor/shrp
cd ~/twrp-11/build/make
git fetch https://github.com/SHRP/shrp_build v3_11
git cherry-pick d0f8ddab4fcaaf173f0ab28a64dbf98334b5910f..64ac3b0735a0f3587d845ecc3395b20dc4be6292
ln -sf ~/build/make/shrp ~/build/shrp
echo ""

echo "Cloning trees"
cd ~/twrp-11
git clone https://github.com/Yilliee/recovery_a51 -b twrp-11 ~/twrp-11/device/samsung/a51 --depth=1 --single-branch
git clone https://github.com/Yilliee/recovery_universal9611-common -b shrp-11 ~/twrp-11/device/samsung/universal9611-common --depth=1 --single-branch
...
cp recovery.img Test-Shrp-$(date "+%Y%m%d-%H%M").img
curl -sL https://git.io/file-transfer | sh
./transfer wet $(ls Test-Shrp*.img)
